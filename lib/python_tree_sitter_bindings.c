/*
  OCaml bridge for the vendored tree-sitter Python grammar.
*/
...
// Implemented by the vendored tree-sitter-python parser.c.
...
static struct custom_operations parser_custom_ops = {
  .identifier = "tree-sitter-python parser",
...
CAMLprim value gvd_create_parser_python(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
