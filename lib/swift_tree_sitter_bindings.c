/*
  OCaml bridge for the vendored tree-sitter Swift grammar.
*/
...
// Implemented by the vendored tree-sitter-swift parser.c.
...
static struct custom_operations parser_custom_ops = {
  .identifier = "tree-sitter-swift parser",
...
CAMLprim value gvd_create_parser_swift(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
