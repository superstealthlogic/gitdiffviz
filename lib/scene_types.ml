...
let visualization_node_kind_to_string = function
  ...
  | Scene_file -> "file"
  | Scene_type_container -> "type_container"
  | Scene_symbol -> "symbol"
  | Scene_function -> "function"
  | Scene_pattern_marker -> "pattern_marker"
  | Scene_issue_marker -> "issue_marker"

let visualization_edge_kind_to_string = function
  | Contains -> "contains"
  | Annotates -> "annotates"
  | Relates_to -> "relates_to"
  | Calls -> "calls"

let render_priority_to_string = function
  | Changed -> "changed"
  | Context -> "context"
