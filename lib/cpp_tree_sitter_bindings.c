/*
  OCaml bridge for the vendored tree-sitter C++ grammar.
*/
...
// Implemented by the vendored tree-sitter-cpp parser.c.
...
static struct custom_operations parser_custom_ops = {
  .identifier = "tree-sitter-cpp parser",
...
CAMLprim value gvd_create_parser_cpp(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
